...
def get_contact_support_keyboard():
    keyboard = [
        [InlineKeyboardButton("❌ Cancel", callback_data="user_about")]
    ]
    return InlineKeyboardMarkup(keyboard)
...
def get_voice_selection_owner():
    ...
    try:
        keyboard = [
            ...
            [
                InlineKeyboardButton("🎵 Deep Bass (MadhurNeural)", callback_data="voice_male1"),
                InlineKeyboardButton("🎵 Ocean Calm (PrabhatNeural)", callback_data="voice_male2")
            ],
            [
                InlineKeyboardButton("🎵 Professional (ArjunNeural)", callback_data="voice_male3"),
                InlineKeyboardButton("🎵 Energetic (ArjunIndicNeural)", callback_data="voice_male4")
            ],
            [InlineKeyboardButton("🎵 Warm Tone (RehaanNeural)", callback_data="voice_male5")],
            ...
            [
                InlineKeyboardButton("🎶 Honey Sweet (SwaraNeural)", callback_data="voice_female1"),
                InlineKeyboardButton("🎶 Crystal Clear (NeerjaNeural)", callback_data="voice_female2")
            ],
            [
                InlineKeyboardButton("🎶 Soft Whisper (AnanyaNeural)", callback_data="voice_female3"),
                InlineKeyboardButton("🎶 Bright Star (AashiNeural)", callback_data="voice_female4")
            ],
            [InlineKeyboardButton("🎶 Melodic Angel (KavyaNeural)", callback_data="voice_female5")],
